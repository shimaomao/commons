package com.spike.commons.algorithm.bean.externalsort.Exmrg2;
...
public class Exmrg2 {
  ...
  static void firstpass(DataInputStream in, DataOutputStream out1, DataOutputStream out2,
    ...
    System.out.println("Process " + numrecs + " records into " + runs + " runs of length "
        + bufrecs);
  ...
  public static void main(String args[]) throws IOException {
    ...
    assert args.length == 3 : "Usage: Exmrg2 <infile> <outfile> <size-in-blocks>";

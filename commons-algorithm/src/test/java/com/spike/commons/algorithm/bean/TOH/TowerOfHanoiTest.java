...
public class TowerOfHanoiTest extends junit.framework.TestCase {
   ...
   */
  /**
   * Compute the moves to solve a Tower of Hanoi puzzle. Function move does (or prints) the actual
   * move of a disk from one pole to another.<br/>
   * 利用中间杆temp，将n个盘从杆start移动到杆goal
   * @param n The number of disks
   * @param start The start pole
   * @param goal The goal pole
   * @param temp The other pole

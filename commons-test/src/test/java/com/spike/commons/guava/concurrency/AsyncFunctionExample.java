 ...
 * @see SettableFuture
 */
class AsyncFunctionExample implements AsyncFunction<Long, String> {

  public static void main(String[] args) throws Exception {
    ListeningExecutorService executor =
        MoreExecutors.listeningDecorator(Executors.newCachedThreadPool());
    AsyncFunctionExample function = new AsyncFunctionExample(executor);
  ...
  public AsyncFunctionExample(ListeningExecutorService executor) {

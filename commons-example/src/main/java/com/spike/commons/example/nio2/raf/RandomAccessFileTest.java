package com.spike.commons.example.nio2.raf;
...
import com.spike.commons.example.nio.channel.FileLockTest;
...
public class RandomAccessFileTest {
  ...
  public void positionOfSeekableByteChannel() {
    ...
    bb.put(StringUtils.NEWLINE.getBytes());
    try (SeekableByteChannel channel =
  ...
  /**
   * @see StringUtils#fileChannelPosition()
   * @see StringUtils#channelTransfer()
   * @see FileLockTest
   */
  @Test

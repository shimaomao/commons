...
public class Client {
  ...
  public static void main(String args[]) throws Exception {
    Client client = new Client(ZKConstants.DEFAULT_CONN_STRING);
    client.startZK();
  ...
  public void submitTask(String task, TaskObject taskCtx) {
    ...
    zk.create(ZKConstants.TASK_ZNODE_PATH_PREFIX,//
      task.getBytes(), //
  ...
  private Watcher statusWatcher = new Watcher() {
    ...
    public void process(WatchedEvent event) {
      if (EventType.NodeCreated.equals(event.getType())) {
        ...
        if (event.getPath().contains(ZKConstants.STATUS_TASK_ZNODE_PATH_PREFIX)//
